...
1. Open `Diabetes-Project/Final_Project_Diabetes (1).ipynb` in [Google Colab](https://colab.research.google.com/) or Jupyter.
...
```bash
python Diabetes-Project/final_project_diabetes.py
```
